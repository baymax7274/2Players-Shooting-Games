...
class BuyMenuScene(Scene):
    ...
    def _buy_item(self, item_id):
        ...
        if self.economy.spend(self.buyer_id, defn["price"]):
            # Items are added to player when they return to battle
    ...
    def render(self, screen):
        ...
        # Sections
        wp_section = self.font_small.render("--- 武器 ---", True, (150, 150, 150))
        screen.blit(wp_section, (60, 120))
        item_section = self.font_small.render("--- 道具 ---", True, (150, 150, 150))
        ...
        own_text = self.font_small.render("已拥有武器: " + ", ".join(owned), True, (160, 160, 160))
        screen.blit(own_text, (50, y))

        # Instructions
        inst = self.font_small.render("按1/2数字键在对战中切换武器 | 点击购买 | 完成购买继续", True, (120, 120, 120))
